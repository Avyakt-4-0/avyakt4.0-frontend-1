...
export default function Card({ image, title }: { image: string, title: string }) {
    return (
        <div className="bg-card_border_bg bg-no-repeat p-4 rounded-lg shadow-lg w-[290px] h-[491px] bg-contain flex flex-col  gap-4">
            <div className="flex justify-center rounded-2xl">
                <Image src={image} width={223} height={331} alt={title} className='rounded-2xl p-1 pt-8' />
            </div>
